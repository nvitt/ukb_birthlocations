...
*********************************************************
*** Comparison across education levels in 1951 census ***
*********************************************************

sum census51_age_left_ed_0_14_sh, detail	
local educ_p25 = r(p25)
local educ_p50 = r(p50)
local educ_p75 = r(p75)
...
// Q1:
reg district_different age_gap if census51_age_left_ed_0_14_sh<=`educ_p25', hc3
...
// Q2:
reg district_different age_gap if census51_age_left_ed_0_14_sh>`educ_p25' & census51_age_left_ed_0_14_sh<=`educ_p50', hc3
...
// Q3:
reg district_different age_gap if census51_age_left_ed_0_14_sh>`educ_p50' & census51_age_left_ed_0_14_sh<=`educ_p75', hc3
...
// Q4:
reg district_different age_gap if census51_age_left_ed_0_14_sh>`educ_p75', hc3
...
esttab diff_distr_q1 diff_distr_q2 diff_distr_q3 diff_distr_q4, ///
	...
	mgroup("Quartiles of share left education by age 14:", pattern(1 0 0 0)) ///
	collabels(none) ///
	mlabel("Q1" "Q2" "Q3" "Q4") ///
...
// Latex:
esttab diff_distr_q1 diff_distr_q2 diff_distr_q3 diff_distr_q4 using "${OUTPUT}/tablefragments/distr_diff_regression_by_c51educ_tablefragment.tex", ///
	cells(b(fmt(3)) ci(fmt(3) par)) ///
	collabels(none) ///
	mgroup("Quartiles of share left education by age 14:", pattern(1 0 0 0) ///
...
esttab diff_distr_q1_pars diff_distr_q2_pars diff_distr_q3_pars diff_distr_q4_pars using "${OUTPUT}/tablefragments/distr_diff_regression_by_c51educ_tablefragment.tex", ///
	cells(b(fmt(3)) ci(fmt(3) par)) ///
	collabels(none) ///
