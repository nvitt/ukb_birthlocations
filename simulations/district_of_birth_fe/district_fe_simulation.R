...
### Export simulations:
bigreadr::fwrite2(districts_with_sim_df, "gis_data\\simulations\\district_fe_spatial_simulations.txt", col.names=TRUE, row.names=FALSE, quote=FALSE)

### Export spatial correlations for simulated data
bigreadr::fwrite2(est_moran_df, "gis_data\\simulations\\district_fe_spatial_simulations_corr.txt", col.names=TRUE, row.names=FALSE, quote=FALSE)
